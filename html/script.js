    ...
    products1.forEach(function (product) {
      ...
      <div class="product-info">
        ...
        <div class="product-price" onclick="redirectToProductDetails(%productId4%)">
          ...
          <span class="price-new">MWK%newPrice%</span>
        </div>
        ...
        newHtml = newHtml.replace('%newPrice%', product.price * 100);
    ...
    (function (index) {
      fetch('https://dummyjson.com/products/' + cartItems[index])
       ...
       .then(data => {
        ...
        productPrice.textContent = "MWK" + data.price + ".00";
        ...
        document.getElementById("cart-total").innerHTML = "Total: MWK" + total + ".00";
    ...
    .then(data => {
      ...
      <div class="product-info">
        ...
        <div class="product-price" onclick="redirectToProductDetails(%productId4%)">
          ...
          <span class="price-old">MWK%price%</span>
          <span class="price-new">MWK%newPrice%</span>
        </div>
        <button class="add-to-cart"  onclick="addToCart(%data.id%)"">Add to Cart</button>
      </div>
